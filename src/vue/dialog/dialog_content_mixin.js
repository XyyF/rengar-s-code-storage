import dlgEditLine from './components/dlg_edit_line.vue'
import dlgInfoLine from './components/dlg_info_line.vue'
...
export default {
    ...
    components: {
        [dlgEditLine.name]: dlgEditLine,
        [dlgInfoLine.name]: dlgInfoLine,
    }
}
